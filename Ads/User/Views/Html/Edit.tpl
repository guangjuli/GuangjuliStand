<div class="row">
    <form class="form-horizontal" method="post" action="/man/?user/html/edit">
        <div class="col-md-6 ">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input name="password" type="password" value="{$row['password']}" class="form-control"  placeholder="密码">
                </div>
            </div>
            <div class="form-group">
                <label for="confirm_password" class="col-sm-2 control-label">确认密码</label>
                <div class="col-sm-10">
                    <input name="confirm_password" type="password" value="{$row['password']}" class="form-control"  placeholder="确认密码">
                </div>
            </div>
            <div class="form-group">
